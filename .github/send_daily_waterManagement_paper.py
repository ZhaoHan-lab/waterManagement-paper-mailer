...
QUERIES = [
    'all:"agent" AND all:"wastewater"',
    'all:"multi-agent" AND (all:"wastewater" OR all:"water treatment")',
    'all:"autonomous agent" AND all:"water"',
    'cat:cs.MA AND all:"water"',  # cs.MA 是多智能体系统的专属分类
    'cat:eess.SY AND all:"agent" AND all:"water"',
    'cat:cs.AI AND all:"wwtp"',   # WWTP 是污水处理厂 (Wastewater Treatment Plant) 
]

KEYWORDS = {
    # --- 核心 AI 技术概念 (极高权重) ---
    "multi-agent": 15,            # 多智能体
    "autonomous agent": 15,       # 自主智能体
    "llm-based agent": 15,        # 基于大语言模型的智能体
    "agentic": 12,                # 智能体化的

    # --- 核心污水治理场景 (高权重) ---
    "wastewater treatment": 12,   # 污水处理
    "wwtp": 12,                   # 污水处理厂 (核心高频词)
    "sewage": 10,                 # 污水/下水道
    "water resource recovery": 10,# 水资源回收 (欧美文献常用高端词)

    # --- 智能体在水务中的常见动作 (中等权重) ---
    "reinforcement learning": 8,  # 强化学习 (智能体底层核心算法)
    "process control": 8,         # 过程控制
    "decision making": 8,         # 决策制定
    "pump scheduling": 7,         # 泵站调度
    "aeration control": 7,        # 曝气控制 (污水处理高耗能环节)
    "optimization": 6,            # 优化
}
